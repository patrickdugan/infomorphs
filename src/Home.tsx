...
const Home = (props: HomeProps) => {
  ...
  return (
    ...
    >
      ...
      <div> <IconButton color="primary" component={Link} to="https://t.co/196xoYeTT6?amp=1">
          <ChatOutlined />
        </IconButton> <IconButton color="primary" component={Link} to="https://twitter.com/infomorphs">
          <Twitter />
        </IconButton></div>
    </main>
  );
